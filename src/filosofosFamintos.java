public class filosofosFamintos {
    ...
    public static void main(String[] args) throws Exception{
        int qtde = 2; //número de filósofos
        ...
        for(int i = 0; i < filosofos.length; i++){
            ...
            if(i == filosofos.length - 1){
                filosofos[i] = new Filosofo(garfoDireito, garfoEsquerdo); // último filósofo pega o garfo da direita primeiro para evitar deadlock
            }else {
